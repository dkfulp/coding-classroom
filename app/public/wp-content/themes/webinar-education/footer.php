        ...
        <p class="mb-0 py-3 text-center">
          <?php
            if (!get_theme_mod('lms_education_footer_text') ) { ?>
              <a href="<?php echo esc_url(__('https://www.misbahwp.com/themes/free-webinar-wordpress-theme/', 'webinar-education' )); ?>" target="_blank">
          ...
          <?php if ( get_theme_mod('lms_education_copyright_enable', true) == true ) : ?>
            ...
            <a href="<?php echo esc_url(__('https://wordpress.org', 'webinar-education' )); ?>" rel="generator"><?php  /* translators: %s: WordPress */  printf( esc_html__( ' | Proudly powered by %s', 'webinar-education' ), 'WordPress' ); ?></a>
          <?php endif; ?>
        </p>
      </div>
    </div>
