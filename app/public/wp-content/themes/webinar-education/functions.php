...
if (!function_exists('webinar_education_enqueue_scripts')) {
	...
	function webinar_education_enqueue_scripts() {
	    ...
	    wp_enqueue_style( 'webinar-education-style', get_stylesheet_directory_uri() . '/style.css', array('lms-education-woocommerce-css'), $version );

	    wp_enqueue_style( 'webinar-education-style', get_stylesheet_directory_uri() . '/style.css', array('lms-education-style'), $version );
...
function webinar_education_global_color() {
	...
	';
    wp_add_inline_style( 'webinar-education-style',$theme_color_css );
    wp_add_inline_style( 'webinar-education-woocommerce-css',$theme_color_css );
